...
export const VERIFIER_SYSTEM_PROMPT = [
  ...
  '- Degraded observations (timeouts, errors, unavailable backends, empty',
  '  results from a failed or mis-scoped search) are NOT proof of absence —',
  '  never treat them as confirmation that something does not exist or cannot',
  '  happen. An empty result from a working, correctly scoped search IS evidence.',
