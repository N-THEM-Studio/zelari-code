 ...
 * (t153 · 2026-09-21 tentacle plan P1a).
 *
 ...
 *
 *   - EXPLORE / VERIFY: unchanged text (pinned by taskTool.tentacleContract).
 *   - GENERAL (t153): rewritten from the 6-line stub — the only kind that
 ...
 *     format, so the parent receives evidence, not vibes.
 */
